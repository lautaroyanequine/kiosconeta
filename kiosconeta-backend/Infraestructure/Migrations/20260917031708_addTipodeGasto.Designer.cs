...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20260917031708_addTipodeGasto")]
    partial class addTipodeGasto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Distribuidor", b =>
                {
                    b.Property<int>("DistribuidorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DistribuidorId"));
            ...
            modelBuilder.Entity("Domain.Entities.CierreTurno", b =>
                {
                    ...
                    b.Property<decimal>("EfectivoFinalFondo")
                    ...
                    b.Property<decimal>("VirtualFinalFondo")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Domain.Entities.ProductoTag", b =>
                {
                    b.Property<int>("ProductoTagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProductoTagId"));
                    ...
                    b.HasKey("ProductoTagId");

                    b.HasIndex("ProductoId");

                    b.HasIndex("TagId");

                    b.ToTable("ProductosTag");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Promocion", b =>
                {
                    ...
                    b.Property<decimal?>("PrecioFijoDescuento")
                        .HasColumnType("numeric");
                    ...
                    b.Property<int?>("TagCantidadTagId")
                        .HasColumnType("integer");

                    b.Property<int?>("TagIdCantidad")
                        .HasColumnType("integer");

                    b.Property<int?>("TagIdPorcentaje")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TagCantidadTagId");

                    b.HasIndex("TagIdPorcentaje");
            ...
            modelBuilder.Entity("Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nombre = "Admin",
                            Password = "$2a$11$db2RMmzMd327Pgq0snwNfevPc36C0tp/uOjJ/PXcWmXw2WQMgmmP6"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Venta", b =>
                {
                    ...
                    b.Property<decimal?>("MontoVirtual")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Domain.Entities.Producto", b =>
                {
                    ...
                    b.HasOne("Distribuidor", "DistribuidorNav")
                        .WithMany("Productos")
            ...
            modelBuilder.Entity("Domain.Entities.Promocion", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Tag", "TagCantidad")
                        .WithMany()
                        .HasForeignKey("TagCantidadTagId");

                    b.HasOne("Domain.Entities.Tag", "TagPorcentaje")
                        .WithMany()
                        .HasForeignKey("TagIdPorcentaje")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("TagCantidad");

                    b.Navigation("TagPorcentaje");
                });
