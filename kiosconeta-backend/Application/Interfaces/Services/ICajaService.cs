...
namespace Application.Interfaces.Services
{
    ...
    {
        Task<CajaResumenDTO> GetResumenAsync(int kioscoId, int? anio = null, int? mes = null); Task<IEnumerable<MovimientoCajaResponseDTO>> GetMovimientosAsync(int kioscoId);
