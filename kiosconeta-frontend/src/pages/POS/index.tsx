...
//   Enter  → Agregar primer resultado / confirmar escaneo
// ════════════════════════════════════════════════════════════════════════════
...
import {
  ...
  Barcode, TrendingUp, Clock, AlertCircle, Package
} from 'lucide-react';
...
const POSPage: React.FC = () => {
  ...
  const handleCobrar = useCallback(async () => {
    ...
    try {
      const venta = await ventasApi.create({
        ...
        turnoId: 1, // TODO: reemplazar con turno real
  ...
  }, [cart, user, esEfectivo, montoEfectivo, vuelto, metodoPagoSeleccionado]);
    ...
    <div className="h-full flex flex-col bg-neutral-100 overflow-hidden">
      ...
      <div className="bg-white border-b border-neutral-200 px-4 py-2 flex items-center justify-between shrink-0">
        ...
        <div className="hidden lg:flex items-center gap-4 text-xs text-neutral-400">
          ...
          <span><kbd className="bg-neutral-100 px-1.5 py-0.5 rounded border border-neutral-300 font-mono">Esc</kbd> Cancelar búsqueda</span>
          ...
          <div className="px-3 py-2 bg-white border-b border-neutral-200 space-y-1.5">
            ...
            {ultimoCodigo && (
              <div className={`flex items-center gap-2 text-xs px-3 py-1.5 rounded-lg
                ...
                <Barcode size={13} />
                {codigoFeedback === 'ok' && `✓ Código ${ultimoCodigo} agregado al carrito`}
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1.5 p-3 rounded-xl border-2 transition-all
                        ${sel ? 'border-primary bg-primary/5 text-primary' : 'border-neutral-200 text-neutral-400 hover:border-neutral-300'}`}
                    >
                      <Icon size={20} />
